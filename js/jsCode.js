function handelBtn1(){
  ...
  function handelBtn3(){
      ...
      const textContent =document.getElementById('text3').innerText;
      const clickedItems = document.getElementById('clicked-item');
      const serial=clickedItems.childElementCount;
      const p = document.createElement('p');
      p.innerHTML=`${1+serial}. ${textContent}`;
  ...
  function handelBtn4(){
      ...
      const textContent =document.getElementById('text4').innerText;
      const clickedItems = document.getElementById('clicked-item');
      const serial=clickedItems.childElementCount;
      const p = document.createElement('p');
      p.innerHTML=`${1+serial}. ${textContent}`;
  ...
  function handelBtn5(){
      ...
      const textContent =document.getElementById('text5').innerText;
      const clickedItems = document.getElementById('clicked-item');
      const serial=clickedItems.childElementCount;
      const p = document.createElement('p');
      p.innerHTML=`${1+serial}. ${textContent}`;
